...
public class ProductRepository : IProductRepository
{
	...
	/// <inheritdoc />
	public async Task<IEnumerable<Product>> GetProductsIncludeTeamAsync(int pageNumber = 1, int pageSize = 10, CancellationToken cancellationToken = default)
		=> await _context.Set<Product>()
			.OrderBy(o => o.CreatedAt)
			.Skip((pageNumber - 1) * pageSize)
			.Take(pageSize)
	...
	/// <inheritdoc />
	public async Task<IEnumerable<Product>> GetProductsIncludeBacklogAsync(int pageNumber = 1, int pageSize = 10, CancellationToken cancellationToken = default)
		=> await _context.Set<Product>()
			.OrderBy(o => o.CreatedAt)
			.Skip((pageNumber - 1) * pageSize)
			.Take(pageSize)
	...
	/// <inheritdoc />
	public async Task<IEnumerable<Product>> GetProductsIncludeBacklogIssues(int pageNumber = 1, int pageSize = 10, CancellationToken cancellationToken = default)
		=> await _context.Set<Product>()
			.OrderBy(o => o.CreatedAt)
			.Skip((pageNumber - 1) * pageSize)
			.Take(pageSize)
	...
	/// <inheritdoc />
	public async Task<IEnumerable<Product>> GetProductsIncludeTeamAndBacklogAsync(int pageNumber = 1, int pageSize = 10, CancellationToken cancellationToken = default)
		=> await _context.Set<Product>()
			.OrderBy(o => o.CreatedAt)
			.Skip((pageNumber - 1) * pageSize)
			.Take(pageSize)
